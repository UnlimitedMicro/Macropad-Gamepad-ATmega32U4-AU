/*
 * =====================================================================
 * MicroPad - Universal USB HID Controller Firmware
...
void loop() {
  ...
  // -------------------------------------------------------------------
  long curVolPos = knobVol.read() / 4; // 4 pulses per detent
  ...
  if (abs(potDiff) > 35) { // Hysteresis to eliminate analog jitter
  ...
  // -------------------------------------------------------------------
  // 4. ANALOG JOYSTICK: Smooth Mouse Cursor Navigation & Left Click
  // -------------------------------------------------------------------
  ...
  // -------------------------------------------------------------------
  // 5. SOFTWARE SWITCHER (SW8): Gamemode, Mac, and Windows
  // -------------------------------------------------------------------
